...
(async function () {
  ...
  function showSuspended() {
    ...
    o.innerHTML = (
      ...
      + '<p class="be-offer">Now you can <b>own this shop outright for a one-time Ksh 20,000</b>, no monthly fees. New stock you post on Instagram pulls straight into your shop. WhatsApp ordering, plus category and size filtering, so buyers find what they want fast.</p>'
